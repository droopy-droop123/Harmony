module.exports = {
    main: function(bot, msg) {
        ...
        WolkeApi.picture("lick").then((result) => {
            if (user) {
                const embed = new Discord.RichEmbed()
                    .setTitle(`${msg.author.username} licked ${user.username}`)
                    .setColor("#808080")
                    .setImage(result.url)
            ...
            if (!user) {
                const embed = new Discord.RichEmbed()
                    .setTitle(`Harmony licked the dry ${msg.author.username}`)
                    .setColor("#808080")
                    .setImage(result.url)
